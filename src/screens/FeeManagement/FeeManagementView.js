...
const Data = [
    { "Receipt Id": "ID#4411000","Money": "received", "Transaction Name": "Wallet To Bank Transfer", "Bank": "HBL Bank","Amount": "$50,000","Fee": "$5", "Date and Time": " 10:50 PM 07-11-2023" },
      ...
      <Sidebar setCloseState={closeMenu} />
        <div className={styles.main}>
          <Container className={styles.maindiv}>
            ...
            <Link to="/dashboard/feemanagement"><img src='../../Icons/arrow.svg'/></Link>
              <div>Transaction</div>
